...
function s.chainfilter(re,tp,cid)
	return re:GetHandler():IsSetCard(SET_MEKLORD)
end
function s.filter(c)
...
function s.cfilter(c)
	return c:IsFacedown() or not c:IsSetCard(SET_MEKLORD)
end
...
function s.aclimit(e,re,tp)
	return not re:GetHandler():IsSetCard(SET_MEKLORD)
end
